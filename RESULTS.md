...
| Claim | Value |
|---|---|
| congestion 20 tx/s, un-migr at risk: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.0291 / 0.0069 / 1.0000 / 1.0000 / 0.0068 |
| congestion 20 tx/s, inclusion: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.999 / 0.999 / 0.443 / 0.160 / 0.999 |
| congestion 24 tx/s, un-migr at risk: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.1526 / 0.0408 / 1.0000 / 1.0000 / 0.0377 |
| congestion 24 tx/s, inclusion: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.997 / 0.997 / 0.347 / 0.112 / 0.993 |
| congestion 28 tx/s, un-migr at risk: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.3184 / 0.0781 / 1.0000 / 1.0000 / 0.0723 |
| congestion 28 tx/s, inclusion: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.995 / 0.995 / 0.277 / 0.077 / 0.992 |
| congestion 32 tx/s, un-migr at risk: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.5011 / 0.1149 / 1.0000 / 1.0000 / 0.1107 |
| congestion 32 tx/s, inclusion: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.991 / 0.991 / 0.239 / 0.063 / 0.990 |
| congestion 36 tx/s, un-migr at risk: ECDSA / ECDSA ordered / FN-DSA / ML-DSA / QSentry | 0.7166 / 0.1460 / 1.0000 / 1.0000 / 0.1448 |
...
| ablation ECDSA slack order: un-migr / vuln / incl / PQ incl / FN share / bytes/tx / pending end | 0.1149 / 0.1250 / 0.991 / nan / 0.0000 / 355 / 5548 |
| ablation QSentry: un-migr / vuln / incl / PQ incl / FN share / bytes/tx / pending end | 0.1107 / 0.1228 / 0.990 / 0.931 / 0.0220 / 385 / 6293 |
| ablation QSentry oldest first: un-migr / vuln / incl / PQ incl / FN share / bytes/tx / pending end | 0.4767 / 0.4871 / 0.990 / 0.943 / 0.0214 / 385 / 6164 |
| ablation QSentry no budget: un-migr / vuln / incl / PQ incl / FN share / bytes/tx / pending end | 0.1122 / 0.1314 / 0.967 / 0.631 / 0.0711 / 424 / 20083 |
...
| ablation QSentry fixed weight: un-migr / vuln / incl / PQ incl / FN share / bytes/tx / pending end | 0.1101 / 0.1218 / 0.990 / 0.947 / 0.0190 / 381 / 6006 |
...
| Theorem 1 floor respected (all vulnerable) | yes, all 18 points |
| chain 2 s: floor / un-migr ECDSA / ECDSA ordered / QSentry | 0.000 / 0.0776 / 0.0084 / 0.0084 |
| chain 6 s: floor / un-migr ECDSA / ECDSA ordered / QSentry | 0.000 / 0.3137 / 0.0585 / 0.0566 |
| chain 12 s: floor / un-migr ECDSA / ECDSA ordered / QSentry | 0.000 / 0.5011 / 0.1149 / 0.1107 |
| chain 60 s: floor / un-migr ECDSA / ECDSA ordered / QSentry | 0.000 / 0.7650 / 0.2434 / 0.2393 |
| chain 150 s: floor / un-migr ECDSA / ECDSA ordered / QSentry | 0.600 / 0.9122 / 0.6001 / 0.6001 |
| chain 600 s: floor / un-migr ECDSA / ECDSA ordered / QSentry | 0.900 / 0.9771 / 0.9000 / 0.9000 |
| break time 15 s: un-migr ECDSA / ECDSA ordered / QSentry | 0.7254 / 0.2160 / 0.2107 |
| break time 30 s: un-migr ECDSA / ECDSA ordered / QSentry | 0.6387 / 0.1649 / 0.1605 |
...
| phi 0.05/0.15/0.30/0.50/0.80, un-migr at risk, qsentry | 0.1094 / 0.1125 / 0.1107 / 0.1140 / 0.1203 |
| provisioning 150/250/400/600/900 kB, un-migr at risk, ecdsa-only | 0.9983 / 0.5011 / 0.0347 / 0.0000 / 0.0000 |
| provisioning 150/250/400/600/900 kB, un-migr at risk, ecdsa-ordered | 0.2842 / 0.1149 / 0.0075 / 0.0000 / 0.0000 |
| provisioning 150/250/400/600/900 kB, un-migr at risk, falcon-only | 1.0000 / 1.0000 / 1.0000 / 0.9977 / 0.6528 |
| provisioning 150/250/400/600/900 kB, un-migr at risk, qsentry | 0.2842 / 0.1107 / 0.0073 / 0.0000 / 0.0000 |
| verification-cost sensitivity | max spread 0.000000 |
| V in [1, 60]: un-migr at risk min / max | 0.1107 / 0.1110 |
| epsilon 0.01..0.20 at 20 tx/s: un-migr at risk | 0.0067 / 0.0068 / 0.0069 / 0.0069 / 0.0069 |
| epsilon 0.01..0.20 at 32 tx/s: un-migr at risk | 0.1107 / 0.1107 / 0.1112 / 0.1128 / 0.1146 |
| burstiness mean 38 tx/s, ecdsa-only, multipliers 1/2/4/6 | 0.0000 / 0.0000 / 0.1782 / 0.3152 |
| burstiness mean 38 tx/s, ecdsa-ordered, multipliers 1/2/4/6 | 0.0000 / 0.0000 / 0.0477 / 0.1055 |
| burstiness mean 38 tx/s, qsentry, multipliers 1/2/4/6 | 0.0000 / 0.0000 / 0.0437 / 0.0969 |
| burstiness mean 30 tx/s, ecdsa-only, multipliers 1/2/4/6 | 0.0000 / 0.0000 / 0.0213 / 0.1251 |
| burstiness mean 30 tx/s, ecdsa-ordered, multipliers 1/2/4/6 | 0.0000 / 0.0000 / 0.0050 / 0.0378 |
| burstiness mean 30 tx/s, qsentry, multipliers 1/2/4/6 | 0.0000 / 0.0000 / 0.0049 / 0.0326 |
| flood QSentry un-migr at risk, attack 0/5/10/20 | 0.0551 / 0.0663 / 0.0858 / 0.1315 |
| flood ECDSA-only un-migr at risk, attack 0/5/10/20 | 0.2253 / 0.3146 / 0.4279 / 0.8892 |
| flood ECDSA ordered un-migr at risk, attack 0/5/10/20 | 0.0601 / 0.0715 / 0.0893 / 0.1315 |
| flood QSentry PQ inclusion, attack 0/5/10/20 | 0.9444 / 0.9358 / 0.8541 / nan |
| flood attacker share of capacity at 20 tx/s (bound 0.341) | 0.3311 |
| flood reservation 0.7, no attacker: un-migr at risk / PQ incl | 0.1190 / 0.9369 |
| flood reservation 0.5, no attacker: un-migr at risk / PQ incl | 0.1334 / 0.9592 |
| conceal ecdsa-only 26 tx/s commit-reveal=False: un-migr / incl / latency s / pending end | 0.2253 / 0.997 / 40 / 1260 |
| conceal ecdsa-only 26 tx/s commit-reveal=True: un-migr / incl / latency s / pending end | 0.3273 / 0.992 / 100 / 2504 |
| conceal ecdsa-only 32 tx/s commit-reveal=False: un-migr / incl / latency s / pending end | 0.5011 / 0.991 / 102 / 5548 |
| conceal ecdsa-only 32 tx/s commit-reveal=True: un-migr / incl / latency s / pending end | 0.8119 / 0.941 / 462 / 20842 |
| conceal ecdsa-ordered 26 tx/s commit-reveal=False: un-migr / incl / latency s / pending end | 0.0601 / 0.997 / 39 / 1260 |
| conceal ecdsa-ordered 26 tx/s commit-reveal=True: un-migr / incl / latency s / pending end | 0.0000 / 0.993 / 91 / 466 |
| conceal ecdsa-ordered 32 tx/s commit-reveal=False: un-migr / incl / latency s / pending end | 0.1149 / 0.991 / 91 / 5548 |
| conceal ecdsa-ordered 32 tx/s commit-reveal=True: un-migr / incl / latency s / pending end | 0.0000 / 0.949 / 397 / 799 |
| conceal qsentry 26 tx/s commit-reveal=False: un-migr / incl / latency s / pending end | 0.0551 / 0.993 / 79 / 3208 |
| conceal qsentry 26 tx/s commit-reveal=True: un-migr / incl / latency s / pending end | 0.0000 / 0.993 / 91 / 466 |
| conceal qsentry 32 tx/s commit-reveal=False: un-migr / incl / latency s / pending end | 0.1107 / 0.990 / 107 / 6293 |
...
| aging 32 tx/s wait inf/300/120/60/24: un-migr at risk | 0.1107 / 0.1501 / 0.1621 / 0.1614 / 0.1538 |
| aging 32 tx/s: PQ inclusion | 0.9312 / 0.9885 / 0.9975 / 0.9990 / 0.9992 |
| aging 26 tx/s wait inf/300/120/60/24: un-migr at risk | 0.0551 / 0.1780 / 0.2028 / 0.1863 / 0.1383 |
...
| horizon 32 tx/s ECDSA ordered, pending at end @200/1000/5000 | 3543 / 5131 / 4692 |
| horizon 32 tx/s QSentry, vuln at risk @200/1000/5000 blocks | 0.1318 / 0.1222 / 0.1195 |
| horizon 32 tx/s QSentry, pending at end @200/1000/5000 | 4686 / 6311 / 6204 |
...
| horizon 38 tx/s ECDSA ordered, pending at end @200/1000/5000 | 18116 / 28167 / 37980 |
| horizon 38 tx/s QSentry, vuln at risk @200/1000/5000 blocks | 0.2024 / 0.1807 / 0.1708 |
| horizon 38 tx/s QSentry, pending at end @200/1000/5000 | 18152 / 28204 / 37980 |
| horizon 38 tx/s QSentry no budget, vuln at risk @200/1000/5000 blocks | 0.2053 / 0.1851 / 0.1756 |
| horizon 38 tx/s QSentry no budget, pending at end @200/1000/5000 | 19585 / 40569 / 128344 |

## Paired tests at the nominal load (QSentry against each variant)

| Baseline | Metric | p | Cohen's d |
|---|---|---|---|
| fee-optimal | at_risk_fraction_legacy | 1.86e-09 | -3.78 |
...
| fee-optimal | window_vuln_p95_s | 8.18e-05 | +0.71 |
| qsentry-no-vq | at_risk_fraction_legacy | 1.24e-01 | +0.02 |
...
| qsentry-no-vq | window_vuln_p95_s | 6.27e-01 | +0.04 |
| hybrid-only | at_risk_fraction_legacy | 1.86e-09 | -42.91 |
| hybrid-only | at_risk_fraction_vuln | 1.86e-09 | -39.03 |
| hybrid-only | at_risk_fraction | 1.86e-09 | -25.65 |
| hybrid-only | bytes_per_tx | 1.86e-09 | -177.02 |
| hybrid-only | window_vuln_p95_s | 1.73e-06 | -15.81 |
| qsentry-no-budget | at_risk_fraction_legacy | 1.29e-01 | -0.05 |
...
| qsentry-no-budget | window_vuln_p95_s | 6.40e-04 | -0.09 |
| qsentry-no-ordering | at_risk_fraction_legacy | 1.86e-09 | -9.53 |
| qsentry-no-ordering | at_risk_fraction_vuln | 1.86e-09 | -9.11 |
| qsentry-no-ordering | at_risk_fraction | 1.86e-09 | -8.90 |
| qsentry-no-ordering | bytes_per_tx | 2.30e-02 | -0.11 |
| qsentry-no-ordering | window_vuln_p95_s | 6.66e-01 | -0.03 |
...
| ecdsa-ordered | window_vuln_p95_s | 6.08e-04 | -0.04 |
| qsentry-oldest-first | at_risk_fraction_legacy | 1.86e-09 | -3.32 |
...
| qsentry-oldest-first | window_vuln_p95_s | 6.04e-05 | +0.73 |
