...
| `suite.py` | thirteen experiments, five figures, paired statistical tests, and the manifest |
...
`results/results.csv` carries an `experiment` column. The suite runs 4,530 configurations
