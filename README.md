...
| `suite.py` | nine experiments, five figures, paired statistical tests, and the manifest |
...
`results/results.csv` carries an `experiment` column. The suite runs 3,270 configurations
